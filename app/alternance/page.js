...
import cv from '../../public/cv-alternance.webp'
...
export default function page() {
  ...
  return (
    <>
      ...
      <main>
        <BannerTest title1="PASCAL KRIEG, DÉVELOPPEUR WEB" title2="EN ALTERNANCE" subtitle1="Spécialité JS-MERN, Next.js" subtitle2="PHP-Symphony-Wordpress" />
        <section id="about" className="about-container reveal-up">
          <h2 className='reveal-4'>Bonjour et Bienvenue,</h2>
          <p className='reveal-4'>
            Je vous propose mes services en tant que développeur web en alternance
          </p>
        ...
        <section id="alternance">
          ...
          <div className="mgn-top reveal-4">
            <a href="/CV-alternant.pdf" className="why-btn">
