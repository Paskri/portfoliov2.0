...
export default function NewWork(props) {
                ...
                <div className="modal-middle-left">
                  ...
                  <ul>
                    {work && work.acf_data && work.acf_data.skills
                      ? JSON.parse(work.acf_data.skills).map((skill, index) => (
                ...
                <div className="modal-middle-right">
                  {work.acf_data.code ? (
                    <div className="git-container">
                      ...
                      <SocialLink link={work.acf_data.code} image={gitImage} />
                    </div>
                  ) : (
                    ''
                  )}
