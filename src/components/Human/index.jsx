        ...
        <div className="human-wrapper">
          <div className="reveal-right block-content">
            <div className="human-content reveal-2">
              ...
              <p>
                Mon objectif premier: <span>Votre réussite</span>. Votre succès
                repose sur une écoute attentive de <span>vos besoins</span>. Mon
                job est de <span>donner vie à votre vision</span> avec mes
                lignes de code.
              </p>
            </div>
          </div>
          ...
          <div className="reveal-left block-content">
            <div className="human-content reveal-4">
              ...
              <p>
                ...
                <span>la meilleure expérience possible </span>à vos utilisateurs
                et donc{' '}
